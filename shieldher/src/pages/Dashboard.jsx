...
const Dashboard = () => {
  ...
  return (
    <motion.div 
      ...
      className="p-4 md:p-8 max-w-lg mx-auto space-y-6 pb-24"
    >
      ...
      <div 
        className="w-full rounded-[16px] p-5 relative overflow-hidden flex justify-between items-center"
        style={{ 
